...
HOBJS		= src/hapax_main.o src/LLNode.o src/word_extractor.o src/word_tally.o
WOBJS		= src/words_main.o src/word_extractor.o
...
$(HEXE) : $(HOBJS)
	$(CC) $(CFLAGS) -o bin/$(HEXE) $(HOBJS)

$(WEXE): $(WOBJS)
	$(CC) $(CFLAGS) -o bin/$(WEXE) $(WOBJS)
